...
// Fixed array of sample expenses keyed by date (YYYY-MM-DD)
const EXPENSES: Record<string, { amount: number; description: string }> = {
...
function generateYearDays(year: number): DayData[] {
